...
public class List {
    ...
    public String toString() {
        ...
        Node current = first;
        while (current != null) {
            sb.append(current.cp.toString()).append(" "); // CharData.toString handles (chr count p cp) 
            current = current.next;
        }
        return sb.toString().trim() + ")"; // Returns exactly one pair of brackets: (element element) 
    }
